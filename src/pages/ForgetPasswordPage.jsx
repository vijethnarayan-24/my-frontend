  ...
  return (
    <main className="flex flex-col md:flex-row h-[100dvh] overflow-hidden m-0 p-0">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center space-y-6 p-6 sm:p-8 md:p-10 text-center">
          {/* Logo + Title */}
          <div className="flex flex-col items-center">
            <img
              src={logo}
              alt="SECL Logo"
              className="w-32 sm:w-36 md:w-40 mb-2 drop-shadow-lg"
            />
          </div>
      ...
      <section className="hidden md:block w-full md:w-1/2 h-full">
        <img
          src={rightBg}
          alt="Students"
